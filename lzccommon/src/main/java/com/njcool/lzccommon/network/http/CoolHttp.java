package com.njcool.lzccommon.network.http;
...
import com.njcool.lzccommon.network.http.request.DownloadRequest;
import com.njcool.lzccommon.network.http.request.GetRequest;
import com.njcool.lzccommon.network.http.request.HeadRequest;
import com.njcool.lzccommon.network.http.request.OptionsRequest;
import com.njcool.lzccommon.network.http.request.PatchRequest;
import com.njcool.lzccommon.network.http.request.PostRequest;
import com.njcool.lzccommon.network.http.request.PutRequest;
import com.njcool.lzccommon.network.http.request.RetrofitRequest;
...
public class CoolHttp {
    ...
    public static Context getContext() {
        if (context == null) {
            throw new IllegalStateException("Please call CoolHttp.init(this) in Application to initialize!");
        }
        return context;
    }
