...
public abstract class CoolShapeHintView extends LinearLayout implements CoolHintView {
	...
	public CoolShapeHintView(Context context){
		super(context);
	}
	
	public CoolShapeHintView(Context context, AttributeSet attrs) {
		super(context, attrs);
	}
