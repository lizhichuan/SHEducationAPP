...
import com.njcool.lzccommon.view.fresh.RefreshDrawable;

/**
 * Created by baoyz on 14/10/30.
 */
public class ChuanSwipeRefreshLayout extends ViewGroup {
    ...
    public ChuanSwipeRefreshLayout(Context context) {
        this(context, null);
    }

    public ChuanSwipeRefreshLayout(Context context, AttributeSet attrs) {
        super(context, attrs);
    ...
    public void setRefreshStyle(int type) {
        ...
        mRefreshView.setImageDrawable(getResources().getDrawable(R.mipmap.refresh_item2));
    }
