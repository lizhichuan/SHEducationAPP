...
import com.njcool.lzccommon.view.rooler.CoolHintView;
 ...
 */
public abstract class CoolLoopPagerAdapter extends PagerAdapter {
    private CoolRollPagerView mViewPager;

    private ArrayList<View> mViewList = new ArrayList<>();

    private class LoopHintViewDelegate implements CoolRollPagerView.HintViewDelegate{
        @Override
    ...
    public CoolLoopPagerAdapter(CoolRollPagerView viewPager){
