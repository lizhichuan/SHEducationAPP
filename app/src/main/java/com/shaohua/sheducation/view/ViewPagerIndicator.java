...
import com.shaohua.sheducation.utils.DensityUtil;
...
public class ViewPagerIndicator extends HorizontalScrollView implements
    ...
    private int unSelectTextColor = getResources().getColor(R.color.white); //设置选中字体的颜色
    private int selectTextColor = getResources().getColor(R.color.common_color); //设置未选中字体的颜色
